          ...
          <div className="col-12">
            ...
            <div className="card p-4">
              <p className="text-center">
                ...
                conçue pour permettre aux utilisateurs de lire et de publier des
                articles de manière simple et efficace. Avec une interface
                ...
                formulaire simple pour publier vos propres articles. Validation
                des formulaires : Recevez un message d'erreur si vous essayez de
